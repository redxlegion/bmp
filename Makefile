...
CONFIG_CLEAN_FILES = beep-media-player.1 bmp.spec bmp.pc intl/Makefile
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/beep-media-player.1.in $(srcdir)/bmp.pc.in \
	$(srcdir)/bmp.spec.in $(srcdir)/config.h.in \
...
X_LIBS = 
X_PRE_LIBS =  -lSM -lICE
abs_builddir = /home/redlegion/eclipse-workspace/bmp
abs_srcdir = /home/redlegion/eclipse-workspace/bmp
...
beep-media-player.1: $(top_builddir)/config.status $(srcdir)/beep-media-player.1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
bmp.spec: $(top_builddir)/config.status $(srcdir)/bmp.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
bmp.pc: $(top_builddir)/config.status $(srcdir)/bmp.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
